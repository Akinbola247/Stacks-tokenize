  ...
  return (
    <div style={Object.assign({}, S.card, { border: isOpen ? '1px solid #FF550E' : S.card.border })}>
      ...
      <div style={Object.assign({}, S.formContainer, { maxHeight: isOpen ? '1000px' : '0px', opacity: isOpen ? 1 : 0, marginTop: isOpen ? '20px' : '0px' })}>
        <form style={S.form} onSubmit={async (e) => { e.preventDefault(); await call([toClarityValue(args['amount'] ?? '', "uint128", 'amount'),toClarityValue(args['recipient'] ?? '', "principal", 'recipient'),]); }}>
...
function FunctionCard_TokenizeV7_SetTokenUri({ num, isOpen, onToggle }: { num: string, isOpen: boolean, onToggle: () => void }) {
  ...
  return (
    <div style={Object.assign({}, S.card, { border: isOpen ? '1px solid #FF550E' : S.card.border })}>
      ...
      <div style={Object.assign({}, S.formContainer, { maxHeight: isOpen ? '1000px' : '0px', opacity: isOpen ? 1 : 0, marginTop: isOpen ? '20px' : '0px' })}>
        <form style={S.form} onSubmit={async (e) => { e.preventDefault(); await call([toClarityValue(args['value'] ?? '', {"string-utf8":{"length":256}}, 'value'),]); }}>
...
function FunctionCard_TokenizeV7_Transfer({ num, isOpen, onToggle }: { num: string, isOpen: boolean, onToggle: () => void }) {
  ...
  const [args, setArgs] = useState<Record<string, string>>({
    'amount': '', 'sender': '', 'recipient': '', 'memo': sampleJsonForAbi({"optional":{"buffer":{"length":34}}}), 
  });
  const setArg = (name: string, value: string) => setArgs(a => Object.assign({}, a, { [name]: value }));
  ...
  return (
    <div style={Object.assign({}, S.card, { border: isOpen ? '1px solid #FF550E' : S.card.border })}>
      ...
      <div style={Object.assign({}, S.formContainer, { maxHeight: isOpen ? '1000px' : '0px', opacity: isOpen ? 1 : 0, marginTop: isOpen ? '20px' : '0px' })}>
        <form style={S.form} onSubmit={async (e) => { e.preventDefault(); await call([toClarityValue(args['amount'] ?? '', "uint128", 'amount'),toClarityValue(args['sender'] ?? '', "principal", 'sender'),toClarityValue(args['recipient'] ?? '', "principal", 'recipient'),toClarityValue(args['memo'] ?? '', {"optional":{"buffer":{"length":34}}}, 'memo'),]); }}>
...
function FunctionCard_TokenizeV7_GetBalance({ num, isOpen, onToggle }: { num: string, isOpen: boolean, onToggle: () => void }) {
  ...
  return (
    <div style={Object.assign({}, S.card, { border: isOpen ? '1px solid #FF550E' : S.card.border })}>
      ...
      <div style={Object.assign({}, S.formContainer, { maxHeight: isOpen ? '1000px' : '0px', opacity: isOpen ? 1 : 0, marginTop: isOpen ? '20px' : '0px' })}>
        <form style={S.form} onSubmit={async (e) => { e.preventDefault(); await call([toClarityValue(args['who'] ?? '', "principal", 'who'),]); }}>
